        ...
        <Card className="rounded-2xl border-0 bg-white shadow-none">
          <CardContent className="flex flex-col items-center px-5 pb-10 pt-5">
            ...
            <div className="mt-8 flex flex-col items-center">
              <p className="[font-family:'Poppins',Helvetica] text-center text-[42px] font-semibold leading-tight tracking-[1.33px] text-[#019a01]">
                R$ 15,90
              </p>
        ...
        <Card className="rounded-2xl border-0 bg-white shadow-none">
          <CardContent className="flex flex-col items-center px-5 pb-8 pt-5">
            ...
            <div className="mt-7 flex w-full flex-col items-center">
              ...
              <p className="mt-4 [font-family:'Poppins',Helvetica] text-center text-[52px] font-semibold leading-tight tracking-[1.69px] text-[#019a01]">
                R$ 25,90
              </p>
